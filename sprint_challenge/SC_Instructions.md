...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  One of the most important things to me in code reviews is reproducibility.
  It is really time consuming to be given code that maybe works on the author's
  computer but doesn't work on yours or another collegues computer. Having a lot
  of very specific dependencies is not conducive to reproducibility.
  Which actually segues well into the next discussion of containers.

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?

  Containers are a helpful way to make a complete package of what is needed to
  run specific software. We won't have to worry about the issue mentioned above,
  where a specific computer has specific dependencies which make another test
  member unable to run their code, because the container carries with the Software
  all of the packages and libraries needed to run the code.
